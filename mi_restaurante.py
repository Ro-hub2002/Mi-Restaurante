...
def guardar():
    ...
    archvio = filedialog.asksaveasfile(mode='w', defaultextension='.txt')
    archvio.write(info_recibo)
    archvio.close()
...
#Lista de productos
lista_comidas = ['pollo', 'cordero', 'pescado', 'merluza', 'kebab', 'pizza', 'higado', 'carne']
lista_bebidas = ['agua', 'soda', 'jugo', 'cola', 'vino', 'aguila', 'poker', 'club']
lista_postres = ['helado', 'fruta', 'brownies', 'flan', 'mousse', 'pastel', 'chocolate', 'coctel']
